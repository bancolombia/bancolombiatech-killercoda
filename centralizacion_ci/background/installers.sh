...
helm install argo-artifacts oci://registry-1.docker.io/bitnamicharts/minio --version 17.0.16 --set image.repository=bitnamilegacy/minio --set image.tag=sha256-953d489a81cc4de7975f90e07202189c4325da39b0b92470b6a13c7ea99e36cd --set fullnameOverride=argo-artifacts --set namespaceOverride=argo-artifacts
