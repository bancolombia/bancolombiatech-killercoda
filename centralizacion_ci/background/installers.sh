...
kubectl -n argo-artifacts rollout status --watch --timeout=600s deployment/argo-artifacts-minio-console
kubectl -n argo-artifacts port-forward --address 0.0.0.0 svc/argo-artifacts-minio-console 9090:9090 > /dev/null &
