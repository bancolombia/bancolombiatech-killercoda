...
helm install argo-artifacts oci://registry-1.docker.io/bitnamicharts/minio --version 17.0.16 --set image.repository=bitnamilegacy/minio --set image.tag=2025.7.23-debian-12-r5 --set clientImage.repository=bitnamilegacy/minio-client --set clientImage.tag=2025.7.21-debian-12-r3 --set fullnameOverride=argo-artifacts --set namespaceOverride=argo-artifacts --set global.security.allowInsecureImages=true
