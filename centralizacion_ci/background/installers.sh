...
helm install argo-artifacts oci://registry-1.docker.io/bitnamicharts/minio --version 17.0.21 --set fullnameOverride=argo-artifacts --set namespaceOverride=argo-artifacts
